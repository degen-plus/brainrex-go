...
// APIClient manages communication with the Brainrex API Explorer API v0.1.1
...
type APIClient struct {
	...
	SentimentAnalysisApi *SentimentAnalysisApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SentimentAnalysisApi = (*SentimentAnalysisApiService)(&c.common)
