...
/* 
LanguageApiService Extracts known crypto entities like coin names, exchanges, media from text.
...
*/
func (a *LanguageApiService) LanguageGetCryptoEntities(ctx context.Context, text Text) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/entity/get_crypto_entities"
...
/* 
LanguageApiService Returns a -1 to 1 score, depending on positive/negative sentiment
...
@return string
*/
func (a *LanguageApiService) LanguageGetGeneralSentiment(ctx context.Context, text Text) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sentiment/get_general_sentiment"
...
/* 
LanguageApiService Sentiment analysis score using a model trained for buy signals.
...
@return string
*/
func (a *LanguageApiService) LanguageGetPriceSentiment(ctx context.Context, text Text) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/language/get_price_sentiment"
